...
class TradrFeatureProcessor:
    ...
    def update_robot_progress(self, obs_dict):
        ...
        linear_stagnation_condition = (avg_lin_vel < 0.04) and (abs(avg_track_vel_x) > 0.1)
...
def main():
    ...
    if len(myargv) == 2:
        ...
        config_name = "tradr_feature_processor_config.yaml"
...
<<<<<<< HEAD
    #fp.loop()
    fp.make_dataset(600, "full")
=======
    fp.loop()
    #fp.make_dataset(600, "stairs")
